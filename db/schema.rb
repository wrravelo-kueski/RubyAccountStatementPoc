...
ActiveRecord::Schema.define(version: 2022_11_29_144503) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "finance_products", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
    t.index ["user_id"], name: "index_finance_products_on_user_id"
  end
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.integer "finance_product_id"
    t.index ["finance_product_id"], name: "index_transactions_on_finance_product_id"
